...
### 1.4b Check the current Zenodo predraft literature gate offline
...
The current 2315Z predraft gate replays no network request.  It verifies the
1,422,899-byte full-overlap Atom response, 5,201-byte exact-ID response,
2,004-byte retrieval receipt, and 655,325-byte normalized ledger, with
SHA-256 values
...
`fbe9b22defc23e84627339f9844ea8c8078ce96e563c6dfca0f559c57b933523`, and
`084e69f06f31c93e5f7b9394da15e088733b45074dc7d59920e86507c516c456`.
The full-overlap feed cutoff is `2026-08-06T23:16:23Z`; all 722 returned
records are in-window and at or before that cutoff.  The ID-keyed comparison
to the `2026-08-06T1123Z` predecessor has zero added/missing, title/abstract,
category, screening, version, and candidate deltas.  The same 28
