...
EXPECTED_SEMANTIC_DIGEST = "dea028466f41a6a186fbcb09f7b5ba8a74d12834dc7f348d0a1f5f04abf4bcf7"
...
@pytest.mark.parametrize(
    ("chart_id", "point", "g_value", "sources", "row_digest", "repair_minor"),
    [
        (
            "g2",
...
def test_repair_pair_is_rejected_at_exact_chart_open_point(
    ...
    assert record["g_value"] == g_value
    assert record["point_is_inside_declared_chart"] is True
...
def test_third_point_is_a_common_zero_inside_two_charts(
    ...
    assert common["chart_function_values"] == {
        "g2": "1/96",
        "g3": "1/256",
        "g4": "0",
    }
