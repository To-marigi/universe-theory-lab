"""Archive and verify the independent 2026-08-06T1123Z Zenodo predraft gate.
...
PRIOR_GATE_LEDGER = Path("references/papers/2026-08-06_paper1_zenodo_gate_arxiv_normalized.json")
RAW_RESPONSE = Path(
...
SOURCE_ID = "arXiv:PaperI-zenodo-predraft-gate-2026-08-06T1123Z"
PRIOR_SOURCE_ID = "arXiv:PaperI-zenodo-gate-recheck-2026-08-06"
GATE_TRIGGER_UTC = "2026-08-06T11:23:00Z"
NORMALIZER_PATH = "scripts/normalize_v042_paper1_zenodo_predraft_gate_20260806T1123Z.py"
CHECK_COMMAND = (
...
FETCH_COMMAND = (
    ".venv\\Scripts\\python.exe "
    "scripts/normalize_v042_paper1_zenodo_predraft_gate_20260806T1123Z.py --fetch"
)
...
PREDRAFT_REVIEWED_VERSION_UPDATE_RATIONALES = {
    "2607.29501": (
...
PREDRAFT_REVIEWED_SHARED_METADATA_RATIONALES = {
    "2608.02182v1": {
...
# This exact delta was independently title/abstract reviewed by Sol.  A changed
# ID delta or candidate set must fail rather than inheriting that review.
EXPECTED_REVIEWED_DELTA: dict[str, Any] = {
    "added_count": 178,
    "added_ids_sha256": "13812bafc110aa41761be9733585fcc4dcdb6dfb3ae83e42cf24de867df89dc6",
    "missing_count": 12,
    "missing_ids_sha256": "e6ab3dd1239a3304cc10db37d989f4a5b95569b451c786cdd5d7e767c5bb3daa",
    "version_pair_count": 178,
    "version_pairs_sha256": "3c2dc8184c8d1a2b28ae739e85020bc5e423383f3f0e14ae7a3e6bc70e09b23b",
...
def _reviewed_delta_decisions(
    ...
    decisions = {
        "sol_title_abstract_review_required": True,
...
def build_ledger() -> dict[str, Any]:
    ...
    ledger["coverage_boundary"] = {
        ...
        "minimum_predraft_contract_status": "SATISFIED_BY_THIS_ARCHIVE_AFTER_SOL_DELTA_REVIEW",
    }
    ledger["reconciliation"] = {
        "status": "PREDRAFT_REVIEWED_VERSIONED_ID_DELTA_RECHECK_COMPLETED",
    ...
    ledger["predraft_gate_recheck"] = {
        ...
        "claim_boundary": (
            ...
            "versioned-ID delta is explicitly recorded; its five new rule-triggered records "
            "and twelve v1-to-v2 replacements were title/abstract reviewed as nonmaterial to "
            "C1--C5; and the two separately queried tracked IDs remain at v1. It does not "
...
def _dataset_snapshot(ledger: dict[str, Any]) -> dict[str, Any]:
    ...
    The normalized ledger is the immutable, complete record of the 178-ID
    comparison.  Repeating its added-ID list and all version-pair diagnostics
...
def source_record(ledger: dict[str, Any], ledger_bytes: bytes) -> dict[str, Any]:
    ...
    return {
        ...
        "version": (
            "official arXiv API Atom responses archived for the 2026-08-06T1123Z Zenodo "
        ...
        "used_for": [
            ...
            "ID-keyed comparison with the independent 2026-08-06 Zenodo preparation gate",
        ...
        "claim_boundary": (
            ...
            "its versioned-ID and category-only metadata deltas are explicitly recorded and "
            "Sol-reviewed as nonmaterial to C1--C5; and the separately queried Xu and "
